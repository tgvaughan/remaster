...
In order to actually visualize the simulation output, we need to load the R script
[[https://github.com/tgvaughan/remaster/blob/master/scripts/trajTools.R][trajTools.R]] which one can find in the =scripts/= subdirectory of the ReMASTER package directory.
The precise command to load this file  depends on where BEAST installs packages on your
system:
- For MacOS :: ~source("~/Library/Application Support/BEAST/2.7/remaster/scripts/trajTools.R")~
- For Linux :: ~source("~/.beast/2.7/remaster/scripts/trajTools.R")~
- Windows :: ~source("C:\Users\<YourName>\BEAST\2.7\remaster\scripts\trajTools.R")~
  where "<YourName>" should be replaced with your Windows user name.

Once the script is loaded, use the following command to load the trajectories into a data frame:
#+begin_src R
...
- [[https://github.com/tgvaughan/remaster/blob/master/examples/ComplexCoalescent.xml][=ComplexCoalescent.xml=]] ::
...
- [[https://github.com/tgvaughan/remaster/blob/master/examples/CoalescentInference.xml][=CoalescentInference.xml=]] ::
...
- [[https://github.com/tgvaughan/remaster/blob/master/examples/EpiBD.xml][=EpiBD.xml=]] ::
...
- [[https://github.com/tgvaughan/remaster/blob/master/examples/SimulatedBDAlignment.xml][=SimulatedBDAlignment.xml=]] ::
